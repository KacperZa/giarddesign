              ...
              <div className="col-start-2 col-span-5 justify-start flex flex-col gap-20">
                ...
                <div className="grid grid-cols-5 gap-11 w-full text-white">
                    <div className='col-span-4 grid grid-cols-4 gap-x-16 gap-4'>
                        <p className='text-grey text-xs font-inter'>O firmie</p>
                        <div className='flex flex-col col-span-4'>
                            <div className="grid grid-cols-4 gap-x-16 gap-10">
                                <p className="font-montserrat font-medium text-5xl col-span-3 leading-[115%] ">Tworzymy z  <span className='italic font-inter font-medium'>pasją</span></p>
                ...
                <div>
                <button className="border-grey pl-5 pr-5 pt-3 pb-3.5 border rounded-full text-grey font-inter font-normal leading-normal flex gap-1 items-center">Zobacz nasze realizacje  <ArrowRight /> </button>
                </div>
